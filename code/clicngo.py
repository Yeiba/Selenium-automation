...
driver = webdriver.Firefox(options=options, executable_path="../chromedriver/geckodriver")
...
driver.get("https://booking.clicngo.info/cr.resa/htlww/Hotel_search.aspx?user=4521&curr=18&ilng=1%22")
time.sleep(10)

citys=driver.find_elements(By.XPATH,"//div[@class='floatCultureLeft cr_cityWidth']")
time.sleep(4)
for city in citys:
    oldratio= int(90)
...
hotelbutt=driver.find_element(By.XPATH,"//input[@class='cr_button-book HtlwwButtonSearch']")
time.sleep(2)
hotelbutt.click()
time.sleep(20)
names= driver.find_elements(By.XPATH,"//*[@class='htlwwHotelDescription']/div/div/a")
for name in names :
    time.sleep(2)
...
l=driver.find_elements(By.XPATH,"//tr[@class='cr_Grid1UnSelectedHeaderItem pagination']/td/a")
el = (len(l))
pages = list(range(1,el+1))
for i in pages:
    time.sleep(10)
    NextButt = driver.find_element(By.XPATH,"//tr[@class='cr_Grid1UnSelectedHeaderItem pagination']/td/a[{}]".format(str(i)))
    time.sleep(3)
    NextButt.click()
    time.sleep(20)
    names= driver.find_elements(By.XPATH,"//*[@class='htlwwHotelDescription']/div/div/a")
...
try:
    for willaya in willayas : 
        time.sleep(2)
        modifybut = driver.find_element(By.XPATH,"//*[@id='Button_Back_Bottom']")
        time.sleep(2)
        modifybut.click()
